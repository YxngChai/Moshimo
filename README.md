...
- Interactive “Temaki Party” section with expandable info
...
- I built the layout section by section
- Solved layout problems as they appeared
- Learned tools only when I needed them
- Iterated the UI organically over time
